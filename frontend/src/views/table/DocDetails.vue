        ...
        <div class="table_view">
            ...
            <el-table class="tableListView" :data="CountDataList" style="width: 100%" max-height="600"
                ...
                <el-table-column align="center" :label="titledate">
                    ...
                    <el-table-column align="center" prop="username" min-width="120" label="任务名称"></el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            clickExportTabel(){
                ...
                window.location.href="https://sai.bbxxjs.com/exlcountdata?aid="+this.$route.params.id+"&time="+Time;
            },
