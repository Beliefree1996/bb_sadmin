        ...
        <el-dialog :title="isAddBtn?'添加录音':'更新录音'" :visible.sync="dialogFormVisible" width="480px">
            <el-form :model="addForm" :rules="rules" ref="addForm" size="small" >
                ...
                <el-form-item prop="path">
                    <el-upload class="upload-demo" action="https://voice.bbxxjs.com/uploadwav" :on-success="succup" :on-preview="handlePreview" :on-remove="handleRemove" :data="updata" accept=".mp3,.wav" :file-list="fileList" list-type="text">
                        <el-button size="small" type="primary">点击上传</el-button>
                        <div slot="tip" class="el-upload__tip">只能上传mp3或wav文件</div>
                    </el-upload>
                </el-form-item>
